...
TextStyle(color: AppColors.buttonTextColor,fontWeight: FontWeight.bold, letterSpacing: 1.0);
...
TextStyle(color: AppColors.buttonTextColor, letterSpacing: 1.0);

//--------Proceed Button---------

const defaultProceedButtonColor = AppColors.secondaryColor;
